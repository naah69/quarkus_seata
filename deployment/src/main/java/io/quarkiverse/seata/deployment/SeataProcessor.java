...
class SeataProcessor {
    ...
    @BuildStep
    void addXidFilter(BuildProducer<CustomContainerRequestFilterBuildItem> requestFilterProducer, BuildProducer<CustomContainerResponseFilterBuildItem> responseFilterProducer) {
